...
const Footer = () => {
  return (
    <div className="h-[23.625rem] sm:h-[24.625rem] md:h-[25.625rem] lg:h-[26.625rem] xl:h-[27.625rem] bg-[#F4F8FB] pt-[4.875rem] bottom-0 z-10">
      <div className="w-11/12 md:w-10/12 mx-auto lg:w-9/12 xl:w-8/12 relative">
