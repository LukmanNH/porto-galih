            ...
            <div className="grid">
              ...
              <p className="font-normal text-justify text-sm md:text-base leading-[22px] lg:text-[1.25rem] text-[#282828] mb-8 lg:leading-10">
                ...
                <a target={"_blank"} href="https://binus.ac.id">
                  <b className="font-semibold text-[#01549F]">
                    BINUS University
                  </b>
                </a>{" "}
                — Day-to-day, I'm contributing on Digital Product Interface,
                Design System, UI Kit and Product Quality Check. My skills
                include digital product design, interactive design, prototyping,
              ...
              <p className="font-normal text-justify text-sm md:text-base lg:text-[1.25rem] text-[#282828] mb-[1.875rem] leading-[22px] lg:leading-10">
                ...
                Dota2, I'm quite confident in support role, and play various
                kinds of heroes like Eart Spirit, Crystal Maiden, and also I can
                play Luna but for support role haha.
              </p>
              <p className="font-normal text-justify text-sm md:text-base lg:text-[1.25rem] text-[#282828] leading-[22px] lg:leading-10">
                I also spend my time on writing, I like to write about my
                personal development progress, and also what I'm working on —
                all my writing journey can be read{" "}
