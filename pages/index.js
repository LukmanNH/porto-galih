    ...
    <>
      ...
      <div className="container-w-full bg-no-repeat bg-center bg-cover bg-hero h-[15.25rem] sm:h-[18.25rem] md:h-[20.25rem] lg:h-[22.25rem] xl:h-[24.25rem] 2xl:h-[29.25rem] flex items-stretch">
        <div className="w-11/12 self-center mx-auto container pt-20 md:pt-24 lg:pt-28 md:w-10/12 lg:w-9/12 xl:w-8/12 2xl:w-10/12">
          <p className="text-[1.5rem] font-sans text-white mx-auto font-bold sm:text-[1.8rem] md:text-[2rem] lg:text-[2.5rem] tracking-wide 2xl:w-8/12">
            Hey, I'm Galih Putra. A struggling Digital Product Designer.
          </p>
        </div>
      </div>
      <div className="w-11/12 container mx-auto pt-[3.625rem] self-center md:10/12 lg:w-9/12 xl:w-8/12 2xl:w-8/12">
        <p className="text-[1.1rem] leading-[2.3rem] font-sans font-light text-[#282828] sm:text-[1.2rem] md:text-[1.3rem] lg:text-[1.5rem] lg:leading-10 2xl:w-8/12 2xl:mx-auto">
        ...
        <p className="mt-[2.375rem] text-[1.1rem] leading-[2.3rem] font-sans font-light text-[#282828] sm:text-[1.2rem] md:text-[1.3rem] lg:text-[1.4rem] 2xl:w-8/12 2xl:mx-auto">
        ...
        <div className="my-20 font-normal w-auto flex text-[#969696] text-[0.9rem] sm:text-[1rem] lg:text-[1.125rem] 2xl:w-8/12 2xl:mx-auto">
