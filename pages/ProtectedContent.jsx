        ...
        <div className="py-36 mx-auto lg:w-[42.313rem]">
          <div className="text-center">
            ...
            <input
              ...
              type="password"
            />
            <div className="cursor-pointer mx-auto bg-[#01549F] hover:bg-[#282828] hover:text-white shadow-custom-button py-[0.625rem] px-12 w-[9.125rem] rounded-[5px] font-medium text-sm text-white">
              <p>Submit</p>
            </div>
          </div>
        </div>
